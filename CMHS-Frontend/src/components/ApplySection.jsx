...
import { Laptop, MapPin, Navigation, Phone, CheckSquare, FileText, Users, CreditCard, Home, Fingerprint, Clock, CheckCircle2, Search, Camera, Download } from 'lucide-react';
...
export default function ApplySection() {
  ...
  const handleFindCenters = () => {
    window.open('https://www.google.com/maps/search/common+service+center+near+me', '_blank');
  };

  return (
    <section id="apply" className="py-16 bg-gradient-to-br from-blue-50 to-indigo-50" ref={ref}>
        ...
        >
          ...
          <div className="flex justify-center space-x-4 mb-12">
            <motion.button
              ...
              className={`px-8 py-4 rounded-full flex items-center space-x-2 transition-colors ${
                activeMethod === 'online'
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {requiredDocuments.map((doc, index) => (
                        ...
                        >
                          ...
                          <h5 className="font-semibold text-lg mb-1">{doc.name}</h5>
                          <p className="text-gray-600 text-sm mb-2">{doc.description}</p>
                          <p className="text-gray-500 text-xs italic">{doc.examples}</p>
                        </motion.div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <p className="text-gray-600 mb-6">
                        Visit your nearest Common Service Center (CSC) or Ayushman Bharat Kendra 
                        with the required documents. Our trained staff will assist you with the 
                        application process.
                      </p>
                      <motion.button
                        whileHover={{ scale: 1.05 }}
